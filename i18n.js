...
const translations = {
    es: {
        ...
        'scan-qr-title': 'Escanea el QR del Garzón',
        'scan-qr-instructions': 'Pídele al garzón que te muestre el código QR de Almíbar',
        'camera-ready': 'Cámara lista para escanear',
        'start-scan': 'ACTIVAR CÁMARA',
        'stop-scan': 'DETENER CÁMARA',
        'ask-waiter-qr': '* Los garzones tienen el código QR oficial de Almíbar',
        
        // Membership Card
        'member-card-title': 'CLUB DE AMIGOS',
        'member-card-subtitle': 'Miembro Oficial',
        'member-since': 'Miembro desde:',
        'member-id': 'ID:',
        'member-benefits': '✨ BENEFICIOS EXCLUSIVOS ✨',
        'member-perks': 'Descuentos especiales • Eventos VIP • Promociones exclusivas',
        'update-info': 'Actualizar Información',
        'download-card': 'DESCARGAR MI TARJETA',
    ...
    en: {
        ...
        'scan-qr-title': 'Scan the Waiter\'s QR',
        'scan-qr-instructions': 'Ask the waiter to show you Almíbar\'s QR code',
        'camera-ready': 'Camera ready to scan',
        'start-scan': 'ACTIVATE CAMERA',
        'stop-scan': 'STOP CAMERA',
        'ask-waiter-qr': '* Waiters have Almíbar\'s official QR code',
        
        // Membership Card
        'member-card-title': 'FRIENDS CLUB',
        'member-card-subtitle': 'Official Member',
        'member-since': 'Member since:',
        'member-id': 'ID:',
        'member-benefits': '✨ EXCLUSIVE BENEFITS ✨',
        'member-perks': 'Special discounts • VIP events • Exclusive promotions',
        'update-info': 'Update Information',
        'download-card': 'DOWNLOAD MY CARD',
